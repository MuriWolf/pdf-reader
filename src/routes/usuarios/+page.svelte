...
<main class="flex flex-col items-start gap-6 mx-auto p-4">
    <hgroup class="max-w-4xl w-full mx-auto">
        <h1 class="text-c-body-text font-bold text-5xl text-left ">Usuários</h1>
    </hgroup>
    <section class="flex gap-4 items-end max-w-4xl w-full mx-auto">
    ...
    <section class="flex flex-col gap-4 max-w-4xl w-full mx-auto bg-c-secondary rounded-2xl p-4 min-h-[300px]">
