    ...
    <section class="max-w-3xl mx-auto mt-4 bg-c-secondary rounded-2xl p-4">
        ...
        <div class="flex gap-4 mt-4 overflow-x-auto pb-4 mb-12"> 
            ...
            {#each selectedFiles as file}
                <div class="flex flex-col gap-2 max-w-24">
                    <div class="w-24 h-16 py-2 rounded-[5px] bg-c-secondary-lighter hover:opacity-80 transition-all" on:click={() => deleteFile(file.name)}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-full mx-auto text-c-primary" fill="currentColor"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
